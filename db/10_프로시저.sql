# 프로시저 
	# 일련의 쿼리를 하나의 함수처럼 실행하기 위한 쿼리의 집합 (함수는 아님)
# 장점 
...
# 프로시저 구현에 사용하는 문법들
# 변수 선언 
	# declare 변수명 타입 default 기본값; (문법) 
    # 위 변수는 begin 바로 아래에 모여 있어야 함  
# 변수값 설정 
	# set 변수명 = 값;         # =은 비교연산자이기때문에 앞에 set붙이기
# 조건문 - if문 
	# if 조건식 then 
    #	실행문;
    # elseif 조건식 then
...
# 반복문 - cursor
    ...
    # 반복 설정 
    # 루프명 : loop 
    # fetch _cursor into 변수명1, 변수명2, ...;     # 패치:하나씩꺼낸다 
