...
public class Ex02_로또 {
	...
	public static void main(String[] args) {
		 ...
		 * 1. 1~45 사이의 중복되지 않는 랜덤한 수 6자리 생성 
		 * 2. 1번에서 생성한 번호를 제외한 번호 하나 랜덤으로 생성 
		...
		//일치하는 번호 개수와 보너스 번호 일치 여부 이용하여 등수 출력
