...
public class Ex05_static {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 */
		클래스A.name = "홍길동"; //static이 붙어서 불러짐
//		클래스A.address = "서울";//static이 안붙어서 안불러짐 에러발생 
		...
		클래스A.name = "임꺽정"; //클래스 시스템을 공유해서 a,b 둘다 임꺽정으로 변경
		객체A.print();
		객체B.print();
		
		System.out.println("객체A의 주소를 경기도로 변경(static 변수 아님)");
		객체A.address = "경기도"; //공유하지않아서 a만 경기도로 바뀜
